...
| ------------------- | -------------------------------- |
|                     |                                  |
 BY | Creator must be credited SA | Derivatives or redistributions must have identical license NC | Only non-commercial uses are allowed ND | No derivatives are allowed
